...
`
	...
	buf.WriteString("ExecStart=/bin/bash -c \"docker run --name kubelet --net=host --cpu-period=500000 --cpu-quota=1000000 --cpu-shares=1024 --memory=1g --privileged --pid=host -v /:/rootfs:ro ")
